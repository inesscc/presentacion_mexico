...
- ~**1800 images** para entrenar (y testear).
...
Entrenar red neuronal con el 80% de los datos
...
### Predicir ingreso como variable continua a partir de características consideradas relevantes 
...
.center[<img src="imagenes/aumentar_imagenes.png" width="400">]
